...
const OrderSummaryScreen = ({
  ...
  const evcFormat = () => {
    ...
    if (evcPrice < 1) {
      ...
      return `Street Point, *712*611242199*${removedPoint}#`
    }
    if (evcPrice % 1 === 0) {
      return `Street Point, *712*611242199*${evcPrice}#`
    }
    if (evcPrice % 1 !== 0) {
      const removedPointGtOne = evcPrice.toString().split('.')
      return `Street Point, *712*611242199*${removedPointGtOne[0]}*${removedPointGtOne[1]}#`
    }
  }
